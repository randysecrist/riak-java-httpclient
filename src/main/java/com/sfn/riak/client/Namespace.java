...
import com.sfn.riak.client.utils.BinaryValue;
import com.sfn.riak.client.utils.DefaultCharset;
...
public class Namespace
{
     ...
     */
    @JsonCreator
    public Namespace(@JsonProperty("bucketType") BinaryValue bucketType, @JsonProperty("bucketName") BinaryValue bucketName)
    {
